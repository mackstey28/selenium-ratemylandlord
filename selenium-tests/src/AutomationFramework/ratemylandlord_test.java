...
{   
    ...
    public static void homepage_search_by_name() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/a[1]")).click(); // click "SEARCH BY NAME"
        Thread.sleep(2000L);
    ...
    public static void homepage_search_by_filter() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/a[2]")).click(); // click "SEARCH BY FILTER"
        Thread.sleep(2000L);
    ...
    public static void create_new_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a/span[1]")).click(); // click on add new landlord
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Paul");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Atreides");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div[4]/a/span[1]")).click(); // click back
        Thread.sleep(2000L);
    ...
    public static void backout_new_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a/span[1]")).click(); // click on add new landlord
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Joe");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Gatto");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a/span[1]")).click(); // click back
        Thread.sleep(2000L);
    ...
    public static void create_duplicate_landlord() throws InterruptedException {
        ...
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Skywalker");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit
        Thread.sleep(1000L);
        /* //sending duplicate
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Anakin");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).click();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).clear();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Skywalker");
        Thread.sleep(1000L);
        */
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit again
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div[4]/a/span[1]")).click(); // click back
        Thread.sleep(2000L);
    ...
    public static void create_empty_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit
        Thread.sleep(2000L);
        
        // check that we get error message
        String error_msg = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[1]/div/div")).getText();
    ...
    public static void create_invalid_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("¥¦Ø†¶£*®#©œŒ±");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("§¡—‰…ƒ¼¾[}@{]<>");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div[4]/a/span[1]")).click(); // click back
    ...
    public static void search_valid_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a/span[1]")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Thomas");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Anderson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).click();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).clear();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Anderson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).click();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).clear();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Cooper");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a")).click(); // go back
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("anderson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        
        String neo = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a[1]/div/h6")).getText();
        Assert.assertEquals(neo, "Anderson Cooper");
        String anderson = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a[1]/div/h6")).getText();
    ...
    public static void search_invalid_landlord() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("jimothy");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(2000L);
    ...
    public static void add_review_form_1() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div/input")).sendKeys("Shirley Ann");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Jackson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button/span[1]")).click(); // click submit
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[2]/div[4]/a/span[1]")).click(); // click back
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("shirley ann jackson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a/div/h6")).click();
        Thread.sleep(1000L);

        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/div/div/input")).sendKeys("RPI Student"); // input reviewer name
        Thread.sleep(1000L);
        ...
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a")); // click Back to Search
        Thread.sleep(2000L);
    ...
    public static void add_review_form_2() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("paul");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a/div/h6")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/div/div/input")).sendKeys("Lady Jessica"); // input reviewer name
        Thread.sleep(1000L);
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("Atreides");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a/div/h6")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/div/div/input")).sendKeys("Gurney Halleck"); // input reviewer name
        Thread.sleep(1000L);
    ...
    public static void search_landlord_reviews_2() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("paul atreides");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a/div/h6")).click();
    ...
    public static void search_by_filter_2() throws InterruptedException {
        ...
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Griffin");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button")).click(); // submit
        Thread.sleep(1000L);
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).click();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).clear();
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div/input")).sendKeys("Simpson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/button")).click(); // submit
        Thread.sleep(1000L);

        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[4]/a")).click(); // back

        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("Peter Griffin");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/div/div/input")).sendKeys("Lois Griffin");
        Thread.sleep(1000L);
        WebElement slider = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/span[1]/span[25]")); // select Safety Rating slider
        for (int i = 0; i < 1; i++ ) slider.sendKeys(Keys.ARROW_LEFT); // move to 4
        Thread.sleep(1000L);
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/input")).sendKeys("Homer Simpson");
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[1]/div/div/div/button")).click();
        Thread.sleep(1000L);
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/ul/a")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/div/div/input")).sendKeys("Marge Simpson");
        Thread.sleep(1000L);
        slider = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/div[1]/span[1]/span[25]")); // select Safety Rating slider
        for (int i = 0; i < 5; i++ ) slider.sendKeys(Keys.ARROW_RIGHT); // move to 10
        Thread.sleep(1000L);
